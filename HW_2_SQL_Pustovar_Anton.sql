...
-- 2. Fill in the table employee 70 lines.
...
--4. Fill in the table salary 16 lines:
...
-- in 10 lines from 40 insert non-existent employee_id
...
-- 8.	Change column type role_name from int on varchar(30)
